...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{add_model.pdf}
...
algoritmus k-means, ktoré sa môžu natrénovať aj pomocou kombinovaného
...
\begin{equation}
  skore_{zhluk_i} = \sum_{j=1}^{n} 1 \text{ ak } P(pocetnost_i \leq Q_j) \text{ inak } 0 \text{, pre j } \in (0.05, 0.1, ...)
...
Pri experimentoch sme pracovali v~jazyku~R. Použité knižnice sú zobrazené
pomocou tabuľky~\ref{tab:libraries}.
