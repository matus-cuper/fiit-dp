...
tak 4 nasledujúce kategórie.

\paragraph{Periodické a synchrónne časové rady}
Ide o~najjednoduchšiu kombináciu, keďže každý časový rad má konštantnú časovú
periódu a~zároveň sú všetky časové rady časovo zarovnané na konkrétny časový
bod~\cite{Teng2010}.

\paragraph{Neperiodické a synchrónne časové rady}
Časové rady nemajú žiadnu periodicitu, ale opäť sú časovo
zarovnané~\cite{Teng2010}.

\paragraph{Periodické a asynchrónne časové rady}
Tentokrát nie sú časové rady časovo zarovnané, ale obsahujú periodicitu, čiže
začiatok periódy v~každom časovo rade je iný~\cite{Teng2010}

\paragraph{Neperiodické a asynchrónne časové rady}
Jedná sa o~skupinu, do ktorej spadajú ostatné časové rady, ktoré obsahujú
periodicitu a~ani synchrónnosť~\cite{Teng2010}.
