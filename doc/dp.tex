...
\begin{itemize}
	...
	\item \textbf{Neperiodické a synchrónne časové rady} nemajú žiadnu
	periodicitu, ale opäť sú časovo zarovnané.

	\item \textbf{Periodické a asynchrónne časové rady} nie sú časovo zarovnané,
	ale obsahujú periodicitu, čiže začiatok periódy v~každom časovo rade je iný.

	\item \textbf{Neperiodické a asynchrónne časové rady} predstavujú skupinu, do
	ktorej spadajú ostatné časové rady, ktoré neobsahujú periodicitu a~ani
	synchrónnosť.
\end{itemize}
