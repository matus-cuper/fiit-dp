...
{Študijný program: \indent Inteligentné softvérové systémy \par}
{Autor: \indent \indent \indent \indent \vphantom{.} Bc. Matúš Cuper \par}
{Bakalárska práca: \indent \vphantom{.} Identifikácia neštandardného správania odberateľov v~energetickej sieti \par}
{Vedúci práce: \indent \indent \vphantom{.} Ing. Marek Lóderer \par}
{apríl 2019 \par}
\bigskip
...
{Author: \indent \indent \indent \vphantom{.} Bc. Matúš Cuper \par}
{Bachelor thesis: \indent Identification of abnormal behavior of customers in the power grid \par}
{Supervisor: \indent \indent \vphantom{.} Ing. Marek Lóderer \par}
{April 2019 \par}
\bigskip
...
Cieľom práce je identifikovať v~časových radov spotreby elektrickej energie,
...
rôznymi prístupmi pri identifikácií anomálií, zhlukovaniu časových radov, ale aj
...
intervalov, ktorých priebeh je neobvyklý prípadne náhody.
...
kapitole~\ref{c:conclusion} sú zhodnotené výsledky našej práce.
...
sú následne analyzované pomocou SHESD metódy, čím vznikajú jednotlivé merania
...
poradia merania v~danom dni, čím vznikne denná reprezentácia odberateľa. Výbrané
...
o~výpočet podielu medzi rozdielom nameranej hodnoty a~jej priemerom
a~štandardnej odchýlky, čo môžeme zapísať vzorcom~\ref{eq:z-score2}.
...
Odberatelia označený najvyšším anomálnym skóre sú ďalej analyzovaný pomocou
...
% TODO add peto lau  experiments
% TODO pridat experimenty z noci, porovnat pocty a kvality identifikovanych časových radov, vizualizovať zo dva tri TS
% TODO porovnat casy vypoctov a pomery
...
\subsection{Porovnanie navrhovanej metódy s~existujúcimi}
TODO analyzovat vysledky podobne ako v 4.
